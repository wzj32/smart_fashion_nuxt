<template>
  <section class="flex flex-col h-[800px] max-lg:h-auto items-start max-lg:items-center gap-2.5 relative self-stretch w-full overflow-hidden max-lg:py-16 max-md:py-10 px-20 max-lg:px-4">
    ...
    <div
      ...
      class="absolute top-[69px] left-1/2 -translate-x-1/2 max-lg:relative max-lg:top-auto max-lg:left-auto max-lg:translate-x-0 max-lg:flex max-lg:justify-center max-lg:w-full max-lg:mb-8"
    >
    ...
    >
      <button
        ...
        class="relative flex items-center tracking-[0] leading-normal transition-all duration-300 cursor-pointer bg-transparent border-none p-0 hover:text-slate-200"
