...
const cases: CaseItem[] = [
  ...
  },
  {
    ...
    link: '/cases/ai-customer-service',
    icon: '/images/C.png',
  },
  {
    id: 'ecommerce',
    ...
    badgeTextClass: 'text-violet-600',
    title: '雲端架構設計',
    description: '為企業打造高效能、可擴展、安全可靠的雲端基礎架構，支持企業數位轉型，系統效能提升 200%',
    link: '/cases/cloud-architecture',
    icon: '/images/D.png',
  },
  {
    id: 'data-platform',
    ...
    badgeTextClass: 'text-blue-500',
    title: 'AI 教育訓練模擬系統',
    description: '透過大語言模型創建虛擬角色，讓學員進行逼真的互動式培訓，取代傳統高成本的人力培訓方式',
    link: '/cases/edu-simulation',
    icon: '/images/E.png',
  },
  {
    id: 'realtime-chat',
    ...
    description: '提供 Web、iOS、Android 多平台 SDK，數小時完成整合，訊息延遲 <200ms，支援雲端與私有化部署',
    link: '/cases/realtime-chat',
    icon: '/images/A.png',
  },
  {
    id: 'hsing-penglai',
    ...
    badgeTextClass: 'text-violet-600',
    title: '興蓬萊',
    description: '為米其林餐盤推薦台菜餐廳打造數位化平台，整合線上訂位、數位菜單與電商購物功能',
    link: '/cases/hsing-penglai',
    icon: '/images/B.png',
  },
  {
    id: 'wifi-rental',
    ...
    badgeTextClass: 'text-blue-500',
    title: '台灣租借WiFi',
    description: '為行動 WiFi 租借服務商打造線上預訂平台，整合多元領還方式與自動化訂單管理',
    link: '/cases/wifi-rental',
    icon: '/images/C.png',
  },
  {
    id: 'global-wifi',
    ...
    badgeTextClass: 'text-violet-600',
    title: 'GLOBAL WiFi',
    description: '為出境旅遊 WiFi 租借品牌打造多語言預訂平台，整合機場、宅配、門市等彈性取還貨渠道',
    link: '/cases/global-wifi',
    icon: '/images/D.png',
  },
]
